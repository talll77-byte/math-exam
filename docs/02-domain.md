...
**מה לומדים:** איתור אילוצי מכנה ושורש, ניתוח ריבועי, וחיתוך "וגם" על ציר אחד.

---

## כלל / פרוטוקול (3 צעדים)
...
| סוג פרבולה | סימן | חיובי | שלילי |
|------------|------|-------|-------|
| פרבולה צוחקת | $a>0$ | מחוץ לשורשים | בין השורשים |
| פרבולה בוכה | $a<0$ | בין השורשים | מחוץ לשורשים |
...
!!! warning "מוקש — טעות נפוצה במקורות"
